...
// @Description ⚫︎レスポンスについて: <br> 「paidDueDate」: 支払い期日 フォーマットはRFC3339の文字列, 「publishedDate」: Dateのみ(時間は無し), <br>「paidAmount」: 支払い金額, 　「billedAmount」: 請求金額(支払金額 に手数料4%を加えたものに更に手数料の消費税を加えたもの),  <br>「partnerCompanyBankAccount」: 取引先の口座情報
